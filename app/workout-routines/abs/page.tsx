	...
	return (
		<div data-aos="fade-right">
			...
			<div className="grid grid-rows-2 grid-cols-1  md:grid-cols-2 gap-2">
				<div className="">
					<strong className="text-2xl">Plank</strong>
					<iframe
						...
						width="600"
						height="315"
						src="https://www.youtube.com/embed/Ubkevtdkkdg?rel=0&amp;autoplay=1&mute=1" //embed video for iframe
				...
				<div className=" justify-center  flex flex-col items-center">
					<ul style={{ listStyleType: 'disc' }}>
						...
						<li>
							Engage Core: Tighten your abdominal muscles, glutes, and thighs to
							maintain a stable and straight position.
						</li>
						<li>
				...
				<div className="">
					...
					<div className="flex gap-2 mt-2">
						...
						<div className="flex flex-col ">
							...
							<div>
								Flex waist to raise upper torso from bench, keeping low back on
								bench. Return until back of shoulders contact padded incline
								bench. Repeat.
							</div>
						</div>
					</div>
